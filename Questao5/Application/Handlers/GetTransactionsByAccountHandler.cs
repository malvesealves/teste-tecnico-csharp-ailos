...
namespace Questao5.Application.Handlers
{
    public sealed class GetTransactionsByAccountHandler : IRequestHandler<GetTransactionsByAccountRequest, GetTransactionsByAccountResponse>
    {
        ...
        {
            InfraQueryResponses.GetTransactionsByAccountResponse response = await _mediator.Send(new InfraQueryRequests.GetTransactionsByAccountRequest(request.AccountId), cancellationToken);
